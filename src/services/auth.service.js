...
export async function userUpdateCarteraService(userMail, userData) {
  const usuario = await userModel();
  return await usuario.findOneAndUpdate({ 'Email': userMail }, { $set: { 'Cartera': userData.Cartera } }, {returnDocument: 'after'});
}
